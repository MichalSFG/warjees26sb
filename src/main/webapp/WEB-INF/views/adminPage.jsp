...
<%--                    </li>--%>
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">I'm an admin here!</h1>
                                    ...
                                    <c:forEach items="${allUsers}" var="item">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/admin/changeAccess/${item.id}"
                                                   class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">Allow
                                                    access</a></td>
                                                </c:if>
                                                <c:if test="${item.enabled == 1}">
                                                <a href="/admin/changeAccess/${item.id}"
                                                   class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm">Deny
                                                    access</a>
                                                </c:if>
                                            </td>
                                            <td>
                                                <a href="/admin/deleteUser/${item.id}"
                                                   class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">Delete</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
