                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Podaj numer lotu:</h6>
                            ...
                            <div class="card-body">
                                <form:form method="post">
                                    FR <input type="number" name="flightNumber">
                                    <button type="submit" class="btn btn-success btn-circle">
                                        <i class="fas fa-check"></i>
                                    </button>
                                </form:form>
                                <br>
                                <c:if test="${not empty noFlight}">
                                    <h5 style="color: red">${noFlight}</h5>
                                </c:if>
