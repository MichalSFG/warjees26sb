                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Enter your seat number:</h6>
                            ...
                            <div class="card-body">
                                <form:form action="/flight/seatNo" method="post">
                                    If flight details are correct, enter your seat number:
                                    <label>
                                        <select name="seatNum">
                                ...
                                <br>
                                Otherwise, <a href="/flight/home">Go to Home Page</a>
